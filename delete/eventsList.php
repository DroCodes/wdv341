...
try {
    $sql = "SELECT events_id, events_name,events_description, events_presenter, events_time, events_date FROM wdv341_events";
...
<table>
    ...
    while($row = $stmt->fetch() ){
        ...
        echo "</td>";
        echo "<td>";
        echo "<button class='delete-button' data-event-id='" . $row["events_id"] . "'>Delete</button>";
        echo "</td>";
        echo "</tr>";
    }
    ?>
