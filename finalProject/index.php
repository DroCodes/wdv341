...
try {
    $stmt = $conn->prepare("SELECT id, blog_title, blog_author, blog_date, blog_text FROM blog ORDER BY blog_date DESC");
            ...
            <tbody>
                <?php
                    foreach ($rows as $row) {
                        ...
                        echo "<td><a class='btn btn-success' href='blogEntry.php?id=" . $row["id"] . "'>View</a></td>";
                        echo "</tr>";
                    }
                ?>
            </tbody>
